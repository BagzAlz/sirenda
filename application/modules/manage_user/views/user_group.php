...
<a href="<?php echo base_url()."manage_user/menu/".$data->id_level;?>">
...
function tanya(id)
{
	...
	if(tanya==false)
	{ return false; }else{ window.location.href="<?php echo base_url();?>manage_user/hapus_UG/"+id; }
}
...
function save()
{
      ...
      if(save_method == 'add') 
      {
         url="<?php echo base_url();?>manage_user/addUserGroup/";
      }
      else
      {
        url="<?php echo base_url();?>manage_user/editUserGroup/";
      }
       ...
       // ajax adding data to database
          $.ajax({
            ...
            success: function(data)
            {
               ...
               $('#add').modal('hide');
              window.location.href="<?php echo base_url();?>manage_user/user_group";
            },
 ...
 function edit(id)
    {
      ...
      $.ajax({
        url : "<?php echo base_url();?>manage_user/getUG/"+id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
