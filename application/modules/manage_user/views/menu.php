...
var id=$("#idmenu").val();
	$.ajax({
		url:"<?php echo base_url();?>manage_user/cekID/"+id,
		type: "POST",
		data:"",
...
{
	$.ajax({
		url:"<?php echo base_url();?>manage_user/HapusMenu/"+id,
		type: "POST",
		data:"",
		 success: function(data)
				{
				window.location.href="<?php echo base_url();?>manage_user/menu/<?php echo $uri; ?>";
				}
		});
}
...
savemode="update";
	$.ajax({
		url:"<?php echo base_url();?>manage_user/editMenu/"+id,
		type: "GET",
        dataType: "JSON",
		success: function(data)
				{
...
var type=$("#Hak").val();
	...
	////
		$.ajax({
		url:"<?php echo base_url();?>manage_user/menuLevel1/"+type+"/"+val,
		type: "POST",
		data:"",
		 success: function(data)
				{
...
function pilih(id)
	{
	$.ajax({
		url:"<?php echo base_url();?>manage_user/getDataUg/"+id,
		type: "POST",
		data:"",
		 success: function(data)
				{
...
function simpan()
{
	...
	if(savemode=="update"){
		var vurl ="<?php echo base_url();?>manage_user/updateMenu"; }
	else{
		var vurl ="<?php echo base_url();?>manage_user/simpanMenu"; }
	$.ajax({	
	url:vurl,
	type: "POST",
    data: $('#form').serialize(),
