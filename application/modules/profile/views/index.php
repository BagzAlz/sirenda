...
<h2><b>Photo Profile</b></h2></center>
</header>
<div class="main-box-body clearfix">
<div class="profile-status">
</div>
<img src="<?php echo base_url();?>file_upload/dp/<?php $dp=$this->profile->dataProfile($this->session->userdata("id")); echo $dp->poto;?>" alt="" class="profile-img img-responsive center-block"/>
<div class="profile-label">
<span>Ganti Photo Profile</span>
<form action="<?php echo base_url();?>profile/upload_img" method='post' enctype="multipart/form-data" name="uploadfilexl" id="uploadfilexl" >
...
<h2><b><span>Ubah Data Profile</span></b></h2>
</header>
<div class="main-box-body clearfix">
...
$('#msg').html("<img src='<?php echo base_url();?>plug/img/load.gif'> Please wait...");
	...
	dataType: "JSON",
	 success: function(data)
			...
			$("#inputPassword1").val("");
			if(data=="nopass"){
			 $('#msg').html('<font color="red"><i class="fa fa-warning fa-fw fa-lg"></i>Username/password tidak tersedia!</font>');
			 $("#inputuser").val("");
			}else{
